...
class EmergencyStopButton():
    def __init__(self, fun_set_estop):
    ...
    def create_button(self, value: bool):
        with ui.button('', on_click=lambda: self.on_click_emergency_stop_button()) as self.icon_container:
...
class EmergencyStopButtonTriggered(EmergencyStopButton):
    ...
    def set_icon_props(self):
        ...
        self.icon_container.classes('fixed bottom-4 right-4 z-50 animate-pulse bg-transparent')
...
class EmergencyStopHandler():
    ...
    def create_notification(self):
        ...
        self._emergency_stop_button_triggered.set_tooltip_text(self._emergency_stop_message)
